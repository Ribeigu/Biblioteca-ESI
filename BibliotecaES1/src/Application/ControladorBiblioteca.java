...
public class ControladorBiblioteca {
    ...
    public boolean FazerCadastroLeitor(String nome, String email, String CPF, String senha, String telefone, String endereco, int dataDeNascimento){
    ...
    public boolean FazerCadastroFuncionario(String nome, String email, String CPF, String senha, String telefone, String endereco, int dataDeNascimento){
